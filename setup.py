...
PROJECT = 'wazo_admin_ui_general_settings'
AUTHOR = 'Wazo Authors'
...
setup(
    ...
    description='Wazo Admin UI General Settings',
    ...
    entry_points={
        'wazo_admin_ui.plugins': [
            'general_settings = wazo_plugind_admin_ui_general_settings_official.plugin:Plugin',
        ]
    }
)
